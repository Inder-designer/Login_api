...
export default class ClientController extends Controller {
    ...
    */
    @Post("/save-user")
    public async saveUser(@Body() request: {username:string, email: string, firstName: string, lastName: string, password: string, phoneNumber?: number, language: string }): Promise<IResponse> {
        try {
            const { username, email, firstName, lastName, password, phoneNumber, language } = request;
